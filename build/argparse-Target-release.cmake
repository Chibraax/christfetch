...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET argparse::argparse
                 ...
                 $<$<CONFIG:Release>:${argparse_LINKER_FLAGS_RELEASE}>)
    set_property(TARGET argparse::argparse
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${argparse_INCLUDE_DIRS_RELEASE}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET argparse::argparse
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${argparse_LIB_DIRS_RELEASE}>)
    set_property(TARGET argparse::argparse
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${argparse_COMPILE_DEFINITIONS_RELEASE}>)
    set_property(TARGET argparse::argparse
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${argparse_COMPILE_OPTIONS_RELEASE}>)
